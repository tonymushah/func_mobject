...
public class Open_Field_info implements MouseInputListener{
    ArgPanel to_use;
    ...
    public Open_Field_info(ArgPanel to_use){
    ...
    public void mouseClicked(MouseEvent arg0) {
        ...
        Object to_show = to_d.getInField(to_use.getTo_use());
        new ObjetInfo_Fra(to_show, JFrame.DISPOSE_ON_CLOSE, true);
    }
    @Override
