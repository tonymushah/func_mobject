package utils.class_t_file;

import java.io.*;

import utils.TUtils;

public class ArClass_File {
    File array_file;
    Object[] to_use;
    Class_File[] arFiles;
    ...
    // FINISHED use the function "generate_Cafilename()" below to the class Array_file
    ...
    public ArClass_File(Object[] to_use){
    ...
    public ArClass_File(Object[] to_use, String path){
        this.setTo_use(to_use);
