...
public class File_Class {
    ...
    */
    ...
    public void setUtilis(TCeutils utilis) {
        this.utilis = utilis;
    }
    ...
    public Object[] build_array_field(String path){
        ArFile_Class array = new ArFile_Class(new File(path));
        return array.getTo_create();
    }
    public void build_to_create(){
        try {
            this.to_create = this.getFCConstructor().newInstance(null);
        } catch (Exception e) {
            //TODO: handle exception
            e.printStackTrace();
        }
    ...
    public void build_utilis(){
        ...
        this.setUtilis(new TCeutils(to_create));
    }
